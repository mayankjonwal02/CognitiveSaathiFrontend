...
import { Eye, EyeOff, Facebook, Linkedin, MapPin, Phone, Twitter } from "lucide-react"
      ...
      <header className="border-b border-gray-100 py-4">
        <div className="container mx-auto px-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button className="bg-[#5a81fa] text-white px-6 py-2 rounded-lg" onClick={() => navigate("/signin")}>Login</button>
          </div>
        </div>
      </header>
